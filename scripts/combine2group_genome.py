...
def load_globals():
    ...
    input_path = config["RESULTPATH"] + "/" + config["PROJECT"] + "/" + config["ALIGNER"] + "/countFile_"+config["COUNTER"]
    output_path = config["RESULTPATH"] + "/" + config["PROJECT"] + "/" + config["ALIGNER"] + "/dea_"+config["COUNTER"]
